import { Landmark, Pencil, ChevronRight } from 'lucide-react'

/** The universal "add" entry point on Wealth: connect a bank (automatic,
 *  first and highlighted) or track something manually. Keeping the connect
 *  path inside every add flow is what makes "you can connect more banks"
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-panel" onClick={(e) => e.stopPropagation()}>
        ...
        >
          ...
          <span className="flex-1 min-w-0">
            <span className="block font-medium text-slate-100">Track something manually</span>
            <span className="block text-sm text-slate-400 mt-0.5">
